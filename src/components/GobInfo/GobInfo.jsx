  ...
  return (
    <div className="stats shadow w-full">
      ...
      <div className="stat">
        ...
        <div className="stat-title">Escuelas construidas</div>
      ...
      <div className="stat">
        ...
        <div className="stat-title">Nuevas vías</div>
        <div className="stat-value">100km</div>
      ...
      <div className="stat">
        ...
        <div className="stat-title">Puentes construidos</div>
      ...
      <div className="stat">
        ...
        <div className="stat-title">Personas encuestadas</div>
      ...
      <div className="stat">
        ...
        <div className="stat-title">Más de</div>
